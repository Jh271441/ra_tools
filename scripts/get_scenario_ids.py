...
用法：
  python3 scripts/get_scenario_ids.py --job 40390125
  python3 scripts/get_scenario_ids.py --job 40390125 --filter "Base.dpe_assist_channel_triggered.value < 1"
  python3 scripts/get_scenario_ids.py --job 40390125 --job-feature 40390703
  python3 scripts/get_scenario_ids.py --job 40390125 --metrics dpe_assist_channel_triggered dpe_stuck_detect
  python3 scripts/get_scenario_ids.py --job 40390125 --size 500 --out ids.txt
"""
