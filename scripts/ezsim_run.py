...
Usage:
    python3 ezsim_run.py <scenario_id>              # 触发（自动查 tripSegment）
    python3 ezsim_run.py <scenario_id> --wait       # 触发并等待完成
    python3 ezsim_run.py --list                     # 查看所有仿真
    python3 ezsim_run.py --server https://x.x.x.x:port <scenario_id>
"""
...
def _get_trail_trip_segment(scenario_id: str) -> dict:
...
class EzSimClient:
    ...
    def start_by_scenario_id(
        ...
        """
        info = _get_trail_trip_segment(scenario_id)
