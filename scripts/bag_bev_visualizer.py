...
用法：
  python3 scripts/bag_bev_visualizer.py /path/to/road.bag
  python3 scripts/bag_bev_visualizer.py /path/to/sim.bag --output-dir ./my_frames --range 50
  python3 scripts/bag_bev_visualizer.py /path/to/sim.bag --every-n 5      # 每 5 帧画一张
  python3 scripts/bag_bev_visualizer.py /path/to/sim.bag --max-frames 100  # 最多画 100 帧
"""
