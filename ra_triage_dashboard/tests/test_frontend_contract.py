...
class FrontendContractTest(unittest.TestCase):
    def test_frontend_modules_load_in_manifest_order_from_thin_entry(self) -> None:
        ...
        self.assertIn("manual-triage-128", APP_ENTRY_JS)
        ...
        self.assertIn("app.js?v=manual-triage-128", INDEX_HTML)
    ...
    def test_light_theme_keeps_controls_and_non_media_surfaces_readable(self) -> None:
        ...
        self.assertIn('styles.css?v=manual-triage-128', INDEX_HTML)
        ...
        self.assertIn('class="review-expected-output-control"', APP_JS)
        self.assertIn('class="expected-output-rule"', APP_JS)
        self.assertIn("Tags 指向多个期望输出，请先消除冲突", APP_JS)
        self.assertIn(".review-expected-output-meta", STYLES_CSS)
