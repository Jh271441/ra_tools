...
class FrontendContractTest(unittest.TestCase):
    def test_frontend_modules_load_in_manifest_order_from_thin_entry(self) -> None:
        ...
        self.assertIn("manual-triage-42", APP_ENTRY_JS)
        self.assertIn("/static/js/", APP_ENTRY_JS)
        self.assertIn("script.async = false", APP_ENTRY_JS)
        self.assertIn("app.js?v=manual-triage-42", INDEX_HTML)
    ...
    def test_light_theme_keeps_controls_and_non_media_surfaces_readable(self) -> None:
        ...
        self.assertIn('styles.css?v=manual-triage-42', INDEX_HTML)
    ...
    def test_review_panel_separates_issue_tags_and_model_error(self) -> None:
        ...
        self.assertIn("white-space: normal; overflow-wrap: anywhere", STYLES_CSS)
        self.assertIn("overflow: visible; text-overflow: clip", STYLES_CSS)
    ...
    def test_missing_evidence_creation_uses_shared_catalog_and_hint(self) -> None:
        self.assertIn('id="newMissingEvidenceHint"', APP_JS)
        ...
        self.assertNotIn(".custom-evidence-create small", STYLES_CSS)
        self.assertIn(".evidence-option-actions", STYLES_CSS)
