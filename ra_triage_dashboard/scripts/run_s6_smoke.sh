...
export DASHBOARD_SEED_EXAMPLES_ENABLED=false DASHBOARD_DEPLOYMENT_MODE=production DASHBOARD_KYLIN_SSO_ENABLED=true DASHBOARD_TRUST_PROXY_IDENTITY_HEADERS=false DASHBOARD_IDENTITY_DIAGNOSTICS=false
export DASHBOARD_SMOKE_LOOPBACK_ADMIN_ENABLED="${DASHBOARD_SMOKE_LOOPBACK_ADMIN_ENABLED:-false}"
export DASHBOARD_SMOKE_LOOPBACK_ADMIN_USERNAME="${DASHBOARD_SMOKE_LOOPBACK_ADMIN_USERNAME:-}"
export DASHBOARD_SSO_WRITE_USERS="${DASHBOARD_SSO_WRITE_USERS:-}"
export DASHBOARD_TEAM_DEFAULT_MANAGERS="${DASHBOARD_TEAM_DEFAULT_MANAGERS:-}"
