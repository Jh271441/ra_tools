...
class DatabaseRunsMixin:
    ...
    def compare_model_runs(
        ...
        *,
        ...
        where at least one Run has a supported model output. A missing or
        unsupported side remains ``NONE``; only rows missing on both sides are
        excluded from rows, matrices, counts, and pages.
        """
        ...
        for row in rows:
            ...
            if baseline_bucket == "NONE" and candidate_bucket == "NONE":
                continue
